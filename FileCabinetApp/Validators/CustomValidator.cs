...
namespace FileCabinetApp
{
    ...
    public class CustomValidator : IRecordValidator
    {
        ...
        public void ValidateParameters(FileCabinetRecord fileCabinetRecord)
        {
            ...
            if (string.IsNullOrWhiteSpace(fileCabinetRecord.FirstName) || fileCabinetRecord.FirstName.Length < 2 || fileCabinetRecord.FirstName.Length > 60 || !char.IsLetter(fileCabinetRecord.FirstName[0]))
            {
                throw new ArgumentException("incorrect firstName", nameof(fileCabinetRecord));
            }

            if (string.IsNullOrWhiteSpace(fileCabinetRecord.LastName) || fileCabinetRecord.LastName.Length < 2 || fileCabinetRecord.LastName.Length > 60 || !char.IsLetter(fileCabinetRecord.LastName[0]))
            {
